/// <summary>
/// TokenPreviewHint.cs - Core module for the Darl.dev project.
/// </summary>
...
// ***********************************************************************
// <copyright file="TokenPreviewHint.cs" company="Dr Andy's IP LLC">
//     Copyright ©  2015
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace DarlCompiler.Parsing
{
    ...
    public class TokenPreviewHint : GrammarHint
    {
        ...
        /// </summary>
        /// <param name="actionType">Type of the action.</param>
        /// <param name="thisTerm">The this term.</param>
        /// <param name="comesBefore">The comes before.</param>
