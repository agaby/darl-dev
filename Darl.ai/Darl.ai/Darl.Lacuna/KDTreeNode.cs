/// <summary>
/// KDTreeNode.cs - Core module for the Darl.dev project.
/// </summary>
...
namespace Darl.Lacuna
{
    ...
    internal class KDTreeNode
    {
        ...
        private int[] bucket;
        private readonly int discriminator;     // dimension discriminated
        private readonly double partition;    // partition value
