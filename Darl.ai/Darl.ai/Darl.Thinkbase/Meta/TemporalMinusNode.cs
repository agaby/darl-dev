/// <summary>
/// TemporalMinusNode.cs - Core module for the Darl.dev project.
/// </summary>
...
{
    public class TemporalMinusNode : BinaryDarlMetaNode
    {
        /// <summary>
        /// Does the evaluation.
        /// </summary>
        ...
        protected override async Task<object> DoEvaluate(DarlCompiler.Interpreter.ScriptThread thread)
        {
            ...
            var res =  res1 - res2; //n.b ordered Temporal - period, not period - temporal
            Epilogue(thread,res);
            return res;
        }
