/// <summary>
/// GraphML.cs - Core module for the Darl.dev project.
/// </summary>
...
// 
namespace Darl.Thinkbase.GraphML {
    ...
    public partial class keytype {
        ...
        private keytypetype typeField;

        [System.Xml.Serialization.XmlAttributeAttribute(AttributeName = "attr.type")]
        public keytypetype type
        {
            get
            {
        ...
        [System.Xml.Serialization.XmlAttributeAttribute(AttributeName = "attr.name", DataType = "NMTOKEN")]
        public string name
        {
            get
            {
