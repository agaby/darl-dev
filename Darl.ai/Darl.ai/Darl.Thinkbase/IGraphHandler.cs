...
namespace Darl.Thinkbase
{
    ...
    public interface IGraphHandler
    {
        ...
        Task<(List<InteractTestResponse>, DarlVar?)> GraphPass(KnowledgeState ks, IGraphModel model, string subjectId, string targetId, List<string> paths, string completionLineage, List<DarlVar> values, DarlVar? pending, GraphProcess graphProces);
