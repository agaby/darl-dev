...
/*            var sb = new StringBuilder();
        ...
        public void TestLoadedBotProcessing()
        {
            ...
            lm2 = LineageModel.Load(File.OpenRead(model));
            List<DarlVar> values = new List<DarlVar>();
            var str = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("Darl_standard_core.test.TestQuestions.txt"));
        ...
        {
            LineageModel vm = Serializer.Deserialize<LineageModel>(Assembly.GetExecutingAssembly().GetManifestResourceStream("Darl_standard_core.test.thousandquestions.model"));
...
//            Assert.AreEqual(2, fsp.Count);
        ...
        {
            LineageModel vm;
            using (var file = Assembly.GetExecutingAssembly().GetManifestResourceStream("Darl_standard_core.test.thousandquestions4.model"))
            {
        ...
        {
            var model = LineageModel.Load(Assembly.GetExecutingAssembly().GetManifestResourceStream("Darl_standard_core.test.thousandquestionsold.model"));
        }
