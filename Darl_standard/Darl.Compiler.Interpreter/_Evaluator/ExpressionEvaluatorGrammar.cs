...
// ***********************************************************************
// <copyright file="ExpressionEvaluatorGrammar.cs" company="Dr Andy's IP LLC">
//     Copyright © Dr Andy's IP LLC
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace DarlCompiler.Interpreter.Evaluator
{
    ...
    //  Darl's default  runtime provides expression evaluation. 
    ...
    /// <summary>
    /// Class ExpressionEvaluatorGrammar.
    /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionEvaluatorGrammar"/> class.
        /// </summary>
        public ExpressionEvaluatorGrammar()
            : base(caseSensitive: false)
        {
            this.GrammarComments =
      @"Darl expression evaluator. Case-insensitive. Supports big integers, float data types, variables, assignments,
...
bool operations &,&&, |, ||; ternary '?:' operator.";
            ...
            //8. Console
            ConsoleTitle = "Darl Expression Evaluator";
            ConsoleGreeting =
      @"Darl Expression Evaluator 
