/// <summary>
/// LoadTests.cs - Core module for the Darl.dev project.
/// </summary>
...
namespace Darl.GraphQL.Test
{
    ...
    public class LoadTests
    {
        ...
        public ILogger<CosmosDBConnectivity> logger;
        ...
        public void Initialize()
        {
            ...
            logger = new Mock<ILogger<CosmosDBConnectivity>>().Object;
        ...
        public async Task CopyDarlContacts()
        {
            ...
            var cosmos = new CosmosDBConnectivity(config.Object, logger, licensing.Object);
            int count = 0;
            do
            {
