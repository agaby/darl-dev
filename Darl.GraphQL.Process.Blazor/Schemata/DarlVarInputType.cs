...
namespace Darl.GraphQL.Process.Blazor.Schemata
{
    public class DarlVarInputType : InputObjectGraphType<DarlVar>
    {
        public DarlVarInputType()
        {
            ...
            Field<ListGraphType<StringDoublePairInputType>>("categories").Description("possible categories of this input if categorical");
            Field<NonNullGraphType<DarlVarDataTypeEnum>>("dataType").Description("The data type of this input");
