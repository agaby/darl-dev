...
namespace Darl.GraphQL.Process.Blazor.Schemata
{
    public class GraphConnectionType : ObjectGraphType<GraphConnection>
    {
        public GraphConnectionType()
        {
            ...
            Field<ListGraphType<DarlTimeType>>("existence").Description("The period of existence of the connection").Resolve(c => c.Source.existence);
            ...
            Field<ListGraphType<GraphAttributeType>>("properties").Description("Other properties of this connection").Resolve(c => c.Source.properties);
            Field<BooleanGraphType>("virtual").Description("if true the connection is a representative of a fundamental relationship, rather than a real world connection").Resolve(c => c.Source._virtual);
        }
    }
}
