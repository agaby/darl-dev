...
namespace Darl.GraphQL.Process.Blazor.Schemata
{
    public class InputFormatType : ObjectGraphType<InputFormat>
    {
        ...
        public InputFormatType()
        {
            ...
            Field<ListGraphType<StringGraphType>>("categories").Description("All the categories found in the rule set for this input").Resolve(context => context.Source.Categories);
            ...
            Field<InputTypeEnum>("inputType").Description("The data type of the input").Resolve(context => context.Source.InType);
