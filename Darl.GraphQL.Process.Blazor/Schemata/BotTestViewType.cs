...
namespace Darl.GraphQL.Process.Blazor.Schemata
{
    public class BotTestViewType : ObjectGraphType<BotTestView>
    {
        public BotTestViewType()
        {
            ...
            Field<ListGraphType<StoreStateType>>("stores").Description("The store data").Resolve( context => context.Source.stores);
            Field<ListGraphType<StringGraphType>>("conversation").Description("Conversation history").Resolve(context => context.Source.conversation);
