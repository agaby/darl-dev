...
namespace Darl.GraphQL.Models.Schemata
{
    public class TriggerViewInputType : InputObjectGraphType<TriggerViewInput>
    {
        public TriggerViewInputType()
        {
            ...
            Field(c => c.bodyText, true).Description("Either the name of textual i/o or the fixed message body");
            ...
            Field(c => c.sendAttachment,true).Description("The i/o and category that corresponds to a decision to add the attachment, or \"true\",\"false\" if fixed.");
