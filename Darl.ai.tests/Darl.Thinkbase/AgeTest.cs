/// <summary>
/// AgeTest.cs - Core module for the Darl.dev project.
/// </summary>
...
namespace Darl.ai.tests
{
    ...
    public class AgeTest
    {
        ...
        public void SimpleTests()
        {
            ...
            Assert.AreEqual(4, res3.values.Count());
            Assert.AreEqual(0.0, res3.values[0]);
            Assert.AreEqual(1.0, (double)res3.values[1], 0.001);
            Assert.AreEqual(2.0, (double)res3.values[2], 0.001);
            Assert.AreEqual(3.0, (double)res3.values[3], 0.001);
        }
    }
}
