/// <summary>
/// InferenceRecordTypecs.cs - Core module for the Darl.dev project.
/// </summary>
...
namespace Darl.GraphQL.Models.Schemata
{
    public class InferenceRecordType : ObjectGraphType<InferenceRecord>
    {
        public InferenceRecordType()
        {
            ...
            Field<GraphObjectType>("source", "the start object for the inference, annotated with any inferred results.", resolve: c => c.Source.source);
            Field<ListGraphType<StringStringPairType>>("recommendations", "Values that would need to be supplied before an inference could be formed, along with their salience. ", resolve: c => c.Source.recommendations);
        }
    }
}
