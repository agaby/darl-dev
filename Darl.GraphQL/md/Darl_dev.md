...
# Accounts
The darl.dev site is _tenanted_. This means that each user gets a separate account with their own data objects such as rulesets, machined learning models and bot models.
...
We will not tweet or post on your behalf. We will retrieve your email which we will use for billing should you ever exceed the resource limits.
