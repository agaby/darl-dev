...
$(async function () {
    ...
    getks = graph('query gks($id: String! $name: String!){getInteractKnowledgeState(id: $id graphName: $name external: true){knowledgeGraphName data {name value {name lineage value confidence type }}}}')
